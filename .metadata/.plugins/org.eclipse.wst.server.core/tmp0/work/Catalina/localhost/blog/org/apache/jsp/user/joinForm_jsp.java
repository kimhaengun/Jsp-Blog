 ...
 * Generated at: 2021-01-07 15:57:43 UTC
...
public final class joinForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/user/../layout/header.jsp", Long.valueOf(1610033577679L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
        ...
        if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /user/../layout/header.jsp(34,3) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\t\t//DB에서 확인하여 정상이면 isChecking = true\r\n");
      ...
      out.write("\t\t\tdataType:\"text\"//json일 경우 응답 받을 데이터의 타입을 적으면 자바 스크립트 오브젝트로 파싱해줌\r\n");
      out.write("\t\t\t}).done(function(data){\r\n");
      out.write("\t\t\t\tif(data === 'ok'){ //동일 유저네임이 있음\r\n");
      out.write("\t\t\t\t\tisChecking = false;\r\n");
      out.write("\t\t\t\t\t//중복 유저네임 설정확인 후 동일 유저네임으로 재설정 하면 ischecking이 트루인 상태에 있기 때문에 false로 다시\r\n");
